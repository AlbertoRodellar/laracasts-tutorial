...
<x-layout title="Ideas Create">
    <form method="POST" action="/ideas-db">
        ...
        <div class="mt-6 flex items-center  gap-x-6">
            <button type="submit"
                class="rounded-md bg-indigo-500 px-3 py-2 text-sm font-semibold text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 cursor-pointer hover:bg-indigo-600">Save</button>
        </div>
    </form>
</x-layout>
